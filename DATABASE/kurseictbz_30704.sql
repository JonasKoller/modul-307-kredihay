...
--
-- Host: localhost
-- Erstellungszeit: 26. Mrz 2018 um 10:23
...
CREATE TABLE `credit` (
  ...
  `numberOfRates` int(11) NOT NULL,
  `begin` date NOT NULL,
  `rentalStatus` tinyint(1) NOT NULL,
  `fk_creditpackages` int(11) NOT NULL
...
INSERT INTO `credit` (`id`, `lastname`, `firstname`, `email`, `phone`, `numberOfRates`, `begin`, `rentalStatus`, `fk_creditpackages`) VALUES
(1, 'lünsmann', 'iman', 'iman@css.ch', '0987654321', 3, '2018-03-21', 0, 0),
(2, 'lünsmann', 'iman', 'iman@css.ch', '0987654321', 3, '2018-03-21', 0, 1);
